...
class Board:
    def __init__(self, dim_size, num_bombs):
        # let's keep track of those parameters. they'll be helpful later
    ...
    def assign_values_to_board(self):
        ...
        # represent how many neighboring bombs there are, we can precompute these ant it'll save us some
    ...
    def dig(self, row, col):
        ...
        # return True if successful dig, False, bomb dug

        # a few scenarios:
        # hist a bomb -> game over
    ...
    def __str__(self):
            # if you call print on this object, it will print out this function return!
